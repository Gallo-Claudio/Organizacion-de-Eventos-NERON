...
public class MenuSeleccionValidar implements Validator {
	...
	public void validate(Object target, Errors errors) {
        ...
        int cantidad = menu.getIdmenu().length;
        if(cantidad<3 || cantidad>5) {
        	        	errors.rejectValue("idmenu", "idmenu.incorrect", "Debe elegir como mínimo 3 items y como máximo 5");
        }
	}
}
//-----------------------------------------------------------------------------------        
//        int largo=menu.getIdmenu().length;
        
//        if(largo<3 || largo>5) {
 //       	errors.rejectValue("correo", "correo.incorrect", "Debe elegir como mínimo 3 items y como máximo 5");
