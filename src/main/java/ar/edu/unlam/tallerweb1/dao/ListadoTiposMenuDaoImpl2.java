...
@Repository("listadoTiposMenuDao2")
public class ListadoTiposMenuDaoImpl2 implements ListadoTiposMenuDao2 {

	@Inject
    private SessionFactory sessionFactory;
	List <TipoDeMenu> listadoDeTiposDeMenu2;
	
	@Override
	public List<TipoDeMenu> listarTiposDeMenus2() {
		...
		listadoDeTiposDeMenu2 = session.createCriteria(TipoDeMenu.class).list();
		return (listadoDeTiposDeMenu2);
	}
